...
const Signup = () => {
  ...
  return (
    <div><div className="w-1/4 mx-auto my-7 bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700">
        ...
        <div className="mt-5">
          ...
          <form onSubmit={signupForm.handleSubmit}>
            <div className="grid gap-y-4">
              ...
              <div className="flex items-center">
                <div className="flex">
                  <input
                    ...
                    type="checkbox"
                    onChange={signupForm.handleChange}
                    value={signupForm.values.acceptTerms}
              ...
              {
                  (signupForm.errors.acceptTerms && signupForm.touched.acceptTerms) && (
                    <p className=" text-xs text-red-600 mt-2">
